...
if __name__ == "__main__":
    ...
    user_file = os.path.join(output_dir, USER_FILENAME)
    ...
    # Task 1: Sample 1 percent of users and write them to disk
    print("Sample Users")
    subprocess.run(["python", "extract_rows_sample.py", user_file, user_sample_file, str(SAMPLE_PERCENTAGE)])
